...
export default function BtsDetailPage() {
	...
	const exhibitionId = Array.isArray(params.exhibitionId)
		...
		: params.exhibitionId;
	const btsId = Number(Array.isArray(params.btsId) ? params.btsId[0] : params.btsId);
	...
	return (
		<div className="flex flex-col min-h-screen pb-14">
			...
			<div className="relative aspect-video w-full">
				<Image src={btsItem.imageUrl} alt={btsItem.title} fill className="object-cover" priority />
			</div>
			...
			<div className="flex flex-col px-4">
				...
				{/* SNS 링크 */}
				{btsItem.sns && (
					<a href={btsItem.sns.url} target="_blank" rel="noopener noreferrer" className="mb-6">
						<Button variant="assistive" size="md" className="w-full gap-2 text-element2 mt-2.5">
							<Image
