...
export const MOCK_ARTWORK_LIST: ArtworkListResponse = {
	...
	maps: [
		{
			id: "map-uuid-1",
			imageUrl: "https://s3.amazonaws.com/exhibit/map1.jpg",
			description: "1층 전체 안내도",
		},
		{
			id: "map-uuid-2",
			imageUrl: "https://s3.amazonaws.com/exhibit/map2.jpg",
			description: "2층 구역 상세도",
		},
	],
	artworks: [
		{
			artworkId: "3b251131-1800-4731-860c-034e47340123",
			title: "균열의 정원",
			category: "동양화",
			zone: "2구역",
			mainImage: "https://s3.amazonaws.com/exhibit/garden.jpg",
			artists: [{ id: "uuid-artist-1", name: "이주원" }],
		},
		{
			artworkId: "9f821131-2800-4731-990c-034e47340999",
			title: "숨 쉬는 표면",
			category: "서양화·유화",
			zone: "1구역",
			mainImage: "https://s3.amazonaws.com/exhibit/surface.jpg",
			artists: [{ id: "uuid-artist-2", name: "박세라" }],
		},
	],
};
