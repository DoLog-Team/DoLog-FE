...
export const modalStyles = {
  overlay:
    "fixed inset-0 bg-black/50 backdrop-blur-[2px] animate-in fade-in duration-300 z-[100]",
  ...
  description:
    "text-body1 text-[#606266] mt-[2px] leading-relaxed break-keep whitespace-pre-wrap",
