...
export const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center hover:scale-101 cursor-pointer",
  {
    ...
    compoundVariants: [
      ...
      { variant: "primary",   class: "bg-fg-inverse text-inverse disabled:bg-lighter disabled:text-disable" },
      { variant: "assistive", class: "bg-fg-lighter text-light disabled:bg-lighter disabled:text-disable" },
      { variant: "outline",   class: "border-stroke-lighter text-lighter disabled:text-disable" },
      { variant: "main",      class: "bg-btn-bg text-btn-text disabled:bg-lighter disabled:text-disable" },
      { variant: "cta",       class: "bg-cta-bg text-cta-text disabled:bg-lighter disabled:text-disable" },
